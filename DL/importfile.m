...
%
% Example:
%   data = importfile('data.tsv', 2, 4459);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2018/08/13 12:25:06
...
formatSpec = '%s%f%f%f%f%f%f%f%f%f%f%C%s%s%[^\n\r]';
...
data = table(dataArray{1:end-1}, 'VariableNames', {'PGC_name','PGC_no','vrad','e_vrad','vopt','e_vopt','v','e_v','vvir','zvir','z_err','type','objname','hl_names'});
