...
% DATASET
% dataset_dir='galaxies_filt_med3x3_f_dsift';
...
% dataset_dir=['galaxies/filtered/med_3x3/cropped/all' desc_name];
dataset_dir=['galaxies/filtered/med_3x3/cropped/images_kmeans_' desc_name];
...
nfeat_codebook = 30000; % number of descriptors used by k-means for the codebook generation
norm_bof_hist = 1;
...
if do_svm_llc_linar_classification
    disp('do_svm_llc_linar_classification');
    for i=1:length(desc_train)
